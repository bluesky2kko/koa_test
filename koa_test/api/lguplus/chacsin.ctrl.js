...
// POST => http://21cnkc.iptime.org:4000/api/lguplus/chacsin/userinfo
// POST => http://21cnkc.iptime.org:4000/api/lguplus/chacsin/setforward
// POST => http://21cnkc.iptime.org:4000/api/lguplus/chacsin/stopforward
//
exports.post = async (ctx) => {
    ...
    await request(options, function(err, httpResponse, body) { 
                // console.log("err : " + err);
                // console.log(body);
                let result = {
                    err: true,
                ...
                if (err==null) {
                    ...
                    //
                    result.err = false;
                    result.obj = body.DATAS;    // result.obj = body 나, result.obj = body.DATAS나 vue단에서 결과는 같다 ? 왜 그런지 잘 모르겠음...
